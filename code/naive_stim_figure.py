...
exp_data = expan.get_in_vivo_baseline_data_short(segment=2, DD=dopamine_depletion)
...
# gpe_dir = "data/default_network_mult_seeds/vivo_gpe_stim"
# str_dir = "data/default_network_mult_seeds/vivo_d1_stim"
...
stats_file = open(f"{FIG_DIR}/naive_stim_figure_stats.txt", "w")
...
fig_gpe_grad.savefig("/Users/johnparker/Desktop/fig_gpe_grad.pdf")
plt.close()
run_cmd("open /Users/johnparker/Desktop/fig_gpe_grad.pdf")
...
ax.set_xticks(np.arange(0, len(grad_bin_edges), 2))
ax.set_xticklabels(labels=[f"{x:.3f}" for x in grad_bin_edges[::2]], rotation=25)
fig_str_grad.savefig("/Users/johnparker/Desktop/fig_str_grad.pdf")
plt.close()
run_cmd("open /Users/johnparker/Desktop/fig_str_grad.pdf")
...
fig.savefig(
    f"{FIG_DIR}/naive_stim_figure.pdf",
    bbox_inches="tight",
)
plt.close()
stats_file.close()

run_cmd(f"open {FIG_DIR}/naive_stim_figure.pdf")
